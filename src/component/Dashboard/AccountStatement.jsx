...
const AccountStatement = ({addAmount,userFound}) => {
  ...
  return (
    <div>
      <div className='flex border justify-evenly m-auto w-[700px] h-[200px] items-center mt-4'>
      ...
      <form className=' flex justify-evenly gap-4 w-[700px] border-red-700 m-auto mt-4 mb-4' onSubmit={(e)=> HandleExpenseDataField(e)}>
